<div class="row">
    ...
    <table class="table table-compact table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span id="height_display"></span> <input type="text" id="height" name="height" value="{{ $height }}"></td>
        </tr>
        <tr>
          <td>{{ trans('laravel-filemanager::lfm.resize-new-width') }}</td>
          <td><span id="width_display"></span> <input type="text" id="width" name="width" value="{{ $width }}"></td>
        </tr>
      </tbody>
    </table>
  ...
  <!--   <input type="text" id="height" name="height" value="{{ $height }}"><br>
